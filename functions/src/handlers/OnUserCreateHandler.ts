...
import {AutogeneratedBuyListBuilder} from "../classses/builders/buyLists/AutogeneratedBuyListBuilder";
...
function createAutogeneratedByuList(uid: string): Promise<any> {
    ...
    const buyListBuilder = new AutogeneratedBuyListBuilder(userReference);

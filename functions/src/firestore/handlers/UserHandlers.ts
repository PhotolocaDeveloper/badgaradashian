...
export class UserHandlers {
    ...
    static createDemoObjects(uid: string) {
    ...
    onCreate(userRecord: UserRecord): Promise<any> {
        ...
        return Promise.all([
            UserHandlers.createUserSyncSettings(userId),
            UserHandlers.createAutogeneratedByuList(userId),
            UserHandlers.createDemoObjects(userId)
        ]);
    }

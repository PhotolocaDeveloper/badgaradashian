...
export class InventoryFunctions {
     ...
     * @param context
     */
    deleteRelatedShoppingListItems(snapshot: DocumentSnapshot, context: EventContext) {
     ...
     * @param context
     */
    createOnInventoryEndsNotification(snapshot: DocumentSnapshot, context: EventContext): Promise<any> | undefined {
        if (context.auth === undefined) return undefined;
     ...
     * @param context
     */
    createShoppingListItem(snapshot: DocumentSnapshot, context: EventContext): Promise<any> | undefined {
        if (context.auth === undefined) return undefined;
